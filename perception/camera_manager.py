...
class CameraManager:
    ...
    def start(self) -> bool:
        ...
        try:
            ...
            controls = self.config.get('sensors', {}).get('camera', {}).get('picamera2', {}).get('controls', {})
            if controls:
            ...
            logger.info(f"✓ Picamera2 started: {self.resolution[0]}x{self.resolution[1]} @ {self.framerate}fps")
